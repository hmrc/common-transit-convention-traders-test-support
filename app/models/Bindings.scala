...
object Bindings {
  ...
  implicit val messageIdBinding: PathBindable[MessageId] = new PathBindable[MessageId] {
    override def bind(key: String, value: String): Either[String, MessageId] = Right(MessageId(value))
    override def unbind(key: String, value: MessageId): String               = value.value
  }
