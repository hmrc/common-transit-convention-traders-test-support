...
//    val validateMessageType = new MessageRequestRefiner(MessageType.departureMessages)
//
...
//    val validateMessageType = new ValidateMessageRefiner(MessageType.arrivalMessages)
//
